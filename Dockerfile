...
# This stage installs all required dependencies
FROM python:3.9-slim AS dependency_installer
...
# Copy the installed Python libraries from the dependency_installer stage
COPY --from=dependency_installer /usr/local/lib/python3.9/site-packages /usr/local/lib/python3.9/site-packages
